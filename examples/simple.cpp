...
main()
{
        ...
        Quantum_Numbers quantum_numbers1 = {2,1,0};
        Quantum_Numbers quantum_numbers2 ={2,1,0};


        STO_Basis_Function_Info oxygen_s( 1, quantum_numbers1);
        STO_Basis_Function_Info oxygen_p(1, quantum_numbers2);


        STO_Basis_Function oxygen_1_s(oxygen_s, {1, 0, 0});
        STO_Basis_Function oxygen_2_p(oxygen_p,{2, 1, 0} );
...
//
//                STO_Basis_Function f1(f1_info, {0, 0, 0});
//                STO_Basis_Function f2(f2_info, {3, 0, 0});
//
//
//                result = engine->nuclear_attraction({f1,f2}, {2.5, 0, 0});
