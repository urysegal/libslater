...
template bool STO_Integration_Options::get<bool>(const std::string &name, bool &value) const; // LCOV_EXCL_LINE
template void STO_Integration_Options::set<bool>(const std::string &name, const bool &value) ;// LCOV_EXCL_LINE
template bool STO_Integration_Options::get<int>(const std::string &name, int &value) const;// LCOV_EXCL_LINE
template void STO_Integration_Options::set<int>(const std::string &name, const int &value) ;// LCOV_EXCL_LINE
template bool STO_Integration_Options::get<double>(const std::string &name, double &value) const;// LCOV_EXCL_LINE
template void STO_Integration_Options::set<double>(const std::string &name, const double &value) ;// LCOV_EXCL_LINE
