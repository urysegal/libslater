...
/*     Last change:  H    14 Mar 2009    7:02 pm */
/* CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC */
/* CC                                                                  CCC */
/* CC   4- Tetracentrique coulombienne Fj                              CCC */
/* CC                                                                  CCC */
/* CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC */
doublereal fj_(integer *nx, integer *nu12, integer *nu34, doublereal *ab, 
	doublereal *cd, doublereal *v, doublereal *a12, doublereal *b12, 
	doublereal *a34, doublereal *b34, integer *ng12, integer *ng34, 
	integer *lambda, doublereal *x)
{
